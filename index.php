...
<head>
    ...
    <title>GC forum - Discuss Coding</title>
...
?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x700/?coder" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div class="container my-4">
        ...
        <h1 class="text-center">GC Forum- Browse Categories</h1>
        <div class="row my-4">
            <!-- use for loop for iterate for Categories -->
            <?php
